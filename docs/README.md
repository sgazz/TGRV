# Touchprint Research Platform Documentation

This documentation describes the full TGRV research stack:

- the iOS UIKit touch acquisition app
- the Python Touchprint Analyzer
- feature extraction and statistical validation
- experimental protocol orchestration
- study template management and longitudinal study support

## Start here

1. Read the [Project Overview](overview.md) to understand the goals and system scope.
